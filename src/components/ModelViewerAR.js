            ...
            <div id="ModelViewerContainer">
                <div>
                    <model-viewer id="ModelViewerAR"
                        src="media/3D-files/BlenderglTF.gltf" ios-src="media/3D-files/BlenderFinal1.usdz" poster="media/3D-files/DSW_Poster.png" alt="DSW Chair" background-color="#FFFFFF" camera-controls>
                    </model-viewer>
                </div>
